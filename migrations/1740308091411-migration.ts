...
export class Migration1740308091411 implements MigrationInterface {
    name = 'Migration1740308091411'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_status" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "isOnline" boolean DEFAULT false, "isSuspended" boolean DEFAULT false, "isDeleted" boolean DEFAULT false, CONSTRAINT "PK_892a2061d6a04a7e2efe4c26d6f" PRIMARY KEY ("id"))`);
