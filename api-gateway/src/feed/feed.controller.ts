...
export class FeedController {
    ...
    // News Feed Endpoints
    @Post('news-feed')
    async createNewsFeed(@AuthUser() user, @Body() data: Partial<NewsFeed>): Promise<NewsFeed> {
    ...
    @Get('news-feed/:id')
    async getNewsFeedById(@AuthUser() user, @Param('id', ParseIntPipe) id: number): Promise<NewsFeed> {
    ...
    @Delete('news-feed/:id')
    async deleteNewsFeed(@AuthUser() user, @Param('id', ParseIntPipe) id: number): Promise<void> {
    ...
    async getPostsByNewsFeedId(@AuthUser() user, @Param('id', ParseIntPipe) newsFeedId: number): Promise<PostEntity[]> {
