...
export class Migration1742812291328 implements MigrationInterface {
    name = 'Migration1742812291328'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "live_stream_history" ("id" SERIAL NOT NULL, "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "stream_url" character varying NOT NULL, "newsFeedId" integer, CONSTRAINT "PK_2d52bb9eb3976f3c609e3da86ee" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "text" character varying NOT NULL, "attachment_url" character varying NOT NULL, "userId" character varying, "postId" integer, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "post_attachment" ("id" SERIAL NOT NULL, "attachment_url" character varying NOT NULL, "postId" integer, CONSTRAINT "PK_49a1b6707f8b1d1be26ee91b28d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "post" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "newsFeedId" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reel" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, CONSTRAINT "PK_e52f2a258bef0ce06b3559c4f1a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "story" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, CONSTRAINT "PK_28fce6873d61e2cace70a0f3361" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "news_feed" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "description" text, "visibility" "public"."news_feed_visibility_enum" NOT NULL DEFAULT 'PUBLIC', "reelId" integer, "communityId" character varying, CONSTRAINT "REL_f44d88904dcffb222e66aa1ad6" UNIQUE ("reelId"), CONSTRAINT "PK_9325de5b82b32b083a96e63d8d8" PRIMARY KEY ("id"))`);
