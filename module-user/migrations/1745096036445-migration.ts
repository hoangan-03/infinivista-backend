...
export class Migration1745096036445 implements MigrationInterface {
    name = 'Migration1745096036445'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "friends" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "friend_id" uuid NOT NULL, CONSTRAINT "PK_65e1b06a9f379ee5255054021e1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "news_feed_reference" ("id" character varying NOT NULL, CONSTRAINT "PK_a5227acaba4683f0a31870d2eca" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "news_feed_reference"`);
