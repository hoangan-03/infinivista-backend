...
export class Migration1741429845810 implements MigrationInterface {
    name = 'Migration1741429845810'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_emotion_enum" AS ENUM('text', 'attachment')`);
        await queryRunner.query(`CREATE TABLE "message" ("message_id" SERIAL NOT NULL, "sent_at" TIMESTAMP, "seen_at" TIMESTAMP, "is_seen" boolean NOT NULL DEFAULT false, "is_deleted" boolean NOT NULL DEFAULT false, "is_hidden" boolean NOT NULL DEFAULT false, "emotion" "public"."message_emotion_enum" NOT NULL, CONSTRAINT "PK_06a563cdbd963a9f7cbcb25c447" PRIMARY KEY ("message_id"))`);
