...
export class Migration1744281663834 implements MigrationInterface {
    name = 'Migration1744281663834'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "call_history" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "call_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "callerId" character varying, "receiverId" character varying, CONSTRAINT "PK_f7ced49106aa7e0566991bd4c18" PRIMARY KEY ("call_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."group_chat_attachment_status_enum" AS ENUM('SENT_FAILED', 'SENT', 'RECEIVED', 'SEEN', 'DELETED', 'HIDDEN')`);
        await queryRunner.query(`CREATE TABLE "group_chat_attachment" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sent_at" TIMESTAMP, "delete_at" TIMESTAMP, "status" "public"."group_chat_attachment_status_enum" NOT NULL, "emotion" text, "attachment_url" character varying NOT NULL, "attachment_name" character varying, "senderId" character varying, "groupChatGroupChatId" uuid, CONSTRAINT "PK_4a760e34a7caa60a896a72e7661" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_attachment_status_enum" AS ENUM('SENT_FAILED', 'SENT', 'RECEIVED', 'SEEN', 'DELETED', 'HIDDEN')`);
        await queryRunner.query(`CREATE TYPE "public"."message_attachment_emotion_enum" AS ENUM('smile', 'laugh', 'wink', 'sad', 'angry', 'surprised', 'crying', 'heart', 'thumbs_up', 'thumbs_down')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."message_attachment_emotion_enum"`);
        await queryRunner.query(`DROP TYPE "public"."message_attachment_status_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."group_chat_attachment_status_enum"`);
